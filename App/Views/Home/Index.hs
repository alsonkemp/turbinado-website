...
markup= 
        <div>
          ...
          <p>Turbinado is an easy-to-use, <% anchorTag "/Home/Performance" "fricking fast" %> web application framework for Haskell (and the <a href="www.haskell.org/ghc">Glorious Glasgow Haskell Compiler</a>).  Naturally, this website is written in Turbinado, so head over to the <% anchorTag "http://github.com/alsonkemp/turbinado-website/tree/master" "Git repo" %> to see how easy it is to code websites in Turbinado.</p>

          <p><a href="http://en.wikipedia.org/wiki/Turbinado">Turbinado</a> is also that yummy, not-so-refined sugar...</p>
          <h1>Why?</h1>
